<header>
    <div class="header">
        <div class="logo-left">
            <a class="logos" href="{{URL::to('')}}"><img src="{{URL::asset('')}}/{{Config::get('adminconfig.logo');}}"></a>
        </div>    
        ...
        <div class="seach-box head-lin">
            <form class="js-header-livesearch nav-livesearch" accept-charset="UTF-8" action="{{URL::to('postsearch')}}" method="get">
