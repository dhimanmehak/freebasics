        ...
        <div class="grid_12 full_block">
            ...
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    ...
                    <form action="{{URL::to('postmainpage')}}" id="form103" method="post" class="form_container left_label">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <textarea cols="80" id="editor1" name="description" rows="10" class="required">
