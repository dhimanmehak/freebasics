                ...
                <form method="post" id="form" action="{{URL::to('project/poststory')}}" enctype="multipart/form-data">
                    ...
                    <ul class="middle-left">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="upload @if($errors->has('projectvideo')) has-error @endif" id="project_video">
                                    ...
                                    <strong class="center">
                                        ...
                                        <span>MOV, MPEG, AVI, MP4, 3GP, WMV, or FLV • 15MB {{trans('messages.filelimit')}}</span>
                                        <span>JPEG, PNG, GIF, BMP • 15MB {{trans('messages.filelimit')}}</span>
                                        <span>640x480 pixels • 4:3 {{trans('messages.aspectratio')}}</span>
                                    </strong>
                                </div>
                                <p class="help-block videosize" style="display:none">Project video may not be greater than 15000 kilobytes.</p>
                        ...
                        <li class='banner-section'>
                            <input type="submit"  class='btns-green' id="form_submit" style='line-height: 0px; min-height: 45px;  margin-left: 42%;' value="{{trans('messages.updateandcntue')}}">
                        </li>
