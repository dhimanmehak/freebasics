...
<section>
    <div class="login">
        ...
        <div class="login-container col-md-4">
            <div class="holder">               
                <form method="post" action="{{URL::to('posttwittercreatelogin');}}">                    
                    <h2 class="title-log">{{trans('messages.createaccount')}}</h2> 
                    <ol class="login-form">
                        <li class="li1 relative">
                            <div class="user mb2">
                                <div class="avatar inline-block align-middle mr1">
                                    <img alt="" class="avatar-circle-small" height="40" src="{{$image}}" onerror="this.src='{{URL::to('main/images/default.png')}}'" width="40">
                                </div>
                                <p class="inline-block h5 bold align-middle mb1">{{$screenname}}</p>
                            </div>
                        </li>
                        ...
                        <li class="li1 relative">
                            <div class="relative">
                                <input id="pass1" class="input-text full-width js-auto_focus password @if($errors->has('email')) has-error @endif" type="text" placeholder="{{trans('messages.email')}}" name='email' value="{{Input::old('email')}}">
