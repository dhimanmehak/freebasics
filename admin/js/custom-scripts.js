$(function () {
    ...
    $('.limiter').inputlimiter({limit: 60});
    $('.limitershortblurb').inputlimiter({limit: 135});
    $('.limiterbig').inputlimiter({limit: 150});
    $('.limiterlarge').inputlimiter({limit: 300});
    ...
    $('.alert_t').click(function () {
        ...
        var noty_id = noty({
            layout: 'top',
            text: 'This feature is disabled for demo user!',
            modal: true,
            type: 'alert',
        });
    });
...
$(document).on("click", "#submitreward", function () {
    var datastring = $("#form103").serialize();
    $.ajax({
        type: "POST",
        url: "posteditreward",
        data: datastring,
