                        ...
                        (function ($) {
                            $.fn.EnableMultiField = function (options) {
                                options = $.extend({
                                    ...
                                    confirmationMsgOnRemove: 'Are you sure to remove selected reward?',
                                ...
                                return this.each(function () {
									...
									$( "div:first" ).removeClass("elem_extend");
                                            ...
                                            $(newElem).find("*[id!=''][name!='']").each(function () {
                                                if ($(this).attr("id")) {
                                                    ...
                                                    if (strname.indexOf('[]') > -1) {
                                                        $(this).attr("name", strname.substring(0, 7) + "$" + fieldCount + "[]");
                                                    }
                                                }
                                            });
                                            totalCount++;
