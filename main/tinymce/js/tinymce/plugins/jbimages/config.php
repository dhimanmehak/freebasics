...
/*
  ...
  |
  | ------------------------------------------------------------------- */
/*if ($_SERVER['HTTP_HOST'] == "localhost:8080" || $_SERVER['HTTP_HOST'] == "192.168.1.251:8081") {
    $config['img_path'] = '/product-ins/fundstarter-ins/main/editorimages'; // Relative to domain name
} else {
    $config['img_path'] = '/main/editorimages'; // Relative to domain name
}*/

if ($_SERVER['HTTP_HOST'] == "demoserver.scrollnext.com" || $_SERVER['HTTP_HOST']=="localhost"  ) {
    $config['img_path'] = '/freebasics/main/editorimages'; // Relative to domain name
} else {
    $config['img_path'] = '/main/editorimages'; // Relative to domain name
}
