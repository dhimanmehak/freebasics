...
class HomeController extends BaseController {
	...
	public function goal()
	{
		...
		//echo $user_email;
		$pledge_userid = $this->user->checkemailexists($user_email);
        ...
        foreach ($categories as $value) {
    		...
    		return View::make('mainviews.goal',compact('categories'))->with('pledge_userid',$pledge_userid);
  ...
  {
	  return View::make('mainviews.contactus');
  }
   ...
   public function globalgoals()
  {
    ...
    public function sendmailtocreator($projectid, $userid) {
	   ...
	   $subject="View a new comment on your project";
 ...
 public function getpledgedata()
{
	...
	$user_email= Session::get('email');
		...
		$pledge_userid = $this->user->checkemailexists($user_email);
	//echo $pledge_userid;
	$data = DB::table('pledge')->where('pledge_cat',$cat_id)->where('pledge_user','=',$pledge_userid)->count();
