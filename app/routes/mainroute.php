...
Route::get('support/project/{id}/{sort}', 'HomeController@discoverbysupport');
Route::get('advocacy', 'HomeController@advocacy');
...
Route::get('payouts', 'HomeController@payouts');
Route::get('pledge', 'HomeController@pledge');
Route::get('privacy-policy', 'HomeController@privacy');
Route::get('terms-conditions', 'HomeController@terms');
Route::get('nonprofit', 'HomeController@nonprofit');
Route::get('corporates', 'HomeController@corporates');
Route::get('individuals', 'HomeController@individuals');
Route::get('global_goals', 'HomeController@globalgoals');
...
Route::get('facebook/login', 'SignupController@loginWithFacebookNew');
Route::get('fblogin/{catid}', 'SignupController@loginWithFacebook');
Route::get('googlelogin/{id}', 'SignupController@loginWithGoogleNew');
//Route::get('googlelogin', 'SignupController@loginWithGoogle');
Route::get('googlelogin','SignupController@loginWithGoogle');

Route::get('googlelogincallback', 'SignupController@loginWithGoogleCallback');
...
Route::get('instagram/login/{id}', 'SignupController@loginWithInstagramNew');
Route::get('instagram/login', 'SignupController@loginWithInstagram');
...
Route::post('indipay/response','SettingsController@payumoney');
Route::get('indipay/getresponse','SettingsController@payumoneyresponse');
...
Route::post('postbasicupdate/project/{id}', 'CreateController@basicupdate');
Route::get('project/start/{id}', 'CreateController@basicstart');
Route::get('project/financial/{id}', 'CreateController@financial');
Route::post('postbasic', 'CreateController@postbasic');
Route::post('postbasic/update/{id}', 'CreateController@postbasicupdate');
...
Route::post('project/start/deletevideo', 'CreateController@deletevideo');
...
Route::get('project/postdelete/{id}', 'CreateController@postdeleteproject');
...
Route::get('getpledgedata', 'HomeController@getpledgedata');
