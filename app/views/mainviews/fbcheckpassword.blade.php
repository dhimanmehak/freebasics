...
<section>
    <div class="login">
        ...
        <div class="login-container col-md-4">
            <div class="holder">               
                <form method="post" action="{{URL::to('postcheckfbpassword');}}">
                    ...
                    <ol class="login-form">
                        <li class="li1 relative">
                            <div class="user mb2">
                                ...
                                <p class="inline-block h5 bold align-middle mb1"><input type="text" value="{{$user->firstname}} {{$user->lastname}}" name="username" style=" margin-bottom: 0px; border: none;" readonly=""></p>
                            </div>
                        </li>
                        <li class="li1 relative">
                            <div class="relative">
