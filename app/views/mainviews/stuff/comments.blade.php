    ...
    <div class="profile-section">
        <div class="top-profilea">
            <div class="container">
                ...
                <!--                <div class="col-md-4">
                                    <h5 style='text-indent: 5px;'>{{trans('messages.backedprojects')}}<i>(category wise)</i></h5>
        ...
        <div class="profile-botm">
            <div class="container">
                ...
                <div  style="margin-top:5%">
                    <p class="no-content">
                        <strong>{{trans('messages.commentinfo')}}</strong>
                    </p>
                </div>
                @else
                <ul class="dual-profile-left" id="poj_8" style="background:#eee;"> 
                    ...
                    <li class="subs-area" style="text-align:left;padding-left:2%;">
                        <span style="font-weight: bold">{{trans('messages.project')}} :</span> <a href="{{URL::to('project/detail')}}/{{$comment->projectid}}">{{$comment->title}}</a><br><br>
                        <span style="font-weight: bold">{{trans('messages.comment')}} :</span> {{$comment->comment}}<br><br>
                        <span style="font-weight: bold">{{trans('messages.postedon')}} :</span> {{ date("jS F, Y", strtotime($comment->postedon)); }}
                    </li>
                    @endforeach
                </ul>
                @endif
