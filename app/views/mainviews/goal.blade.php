...
?>
 ...
 <div class="tab-content fb-goal-tab-content">
   ...
   <!-- <div role="tabpanel" class="fb-goal-tabpane fb-align-with-goal-tabpane tab-pane fade in active" id="align-with-goal"> -->
      <div class="fb-scroll-to-list">
        <ul class="nav navbar-nav" role="tablist" id="nav-two">
            <li class="current">
                <a class="page-scroll" href="#awg-section-1">
                  <span class="fb-stl-line"></span>
                  <span class="fb-stl-detail">
                    <span class="fb-stl-section-title">Choose Your Goal</span>
            ...
            <li>
                <a class="page-scroll" href="#awg-section-2">
                  <span class="fb-stl-line"></span>
                  <span class="fb-stl-detail">
                    <span class="fb-stl-section-title">Numbers Speak</span>
                    <span class="fb-stl-section-description">Facts that show you the importance of choosing a goal and taking action NOW!</span>
                  </span>
                </a>
            </li>
            <li>
                <a class="page-scroll" href="#awg-section-3">
                  <span class="fb-stl-line"></span>
                  <span class="fb-stl-detail">
                    <span class="fb-stl-section-title">Testimonials</span>
                    
                  </span>
                </a>
            </li>
            <li>
                <a class="page-scroll" href="#awg-section-4">
                  <span class="fb-stl-line"></span>
                  <span class="fb-stl-detail">
                    <span class="fb-stl-section-title">Free Basics Vision</span>
                    <span class="fb-stl-section-description">Our FreeBasics model works on 5 key tenets</span>
                  </span>
                </a>
            </li>
            <!-- <li>
                <a class="page-scroll" href="#awg-section-5">
                  <span class="fb-stl-line"></span>
                  <span class="fb-stl-detail">
                    <span class="fb-stl-section-title">Global Revolutions Starts</span>
                    <span class="fb-stl-section-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>
                  </span>
                </a>
            </li> -->
        </ul>
      </div>
      <section class="fb-home-first-fold fb-awg-first-fold" id="awg-section-1">
        <div class="container">
          <div class="fb-awg-ff-table">
            <div class="fb-awg-ff-table-cell fb-awg-ff-goal-selector-wrap wow fadeInLeft">
              <!-- <img src="images/goal-selector.png" alt="goal selector" /> -->
              <div class="fb-awg-selected-goal">
			  
                <div class="fb-awg-selected-goal-image active" id="goal-image-1">
                  <img class="pledge_image" src="{{URL::asset('main/images/goal-images/no-poverty.png');}}" alt="no poverty"/>
				   <img  class="pledge_image1" src="{{URL::asset('main/images/goal-images/pledge_new.gif');}}" alt="no poverty">
				  
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-2">
                  <img src="{{URL::asset('main/images/goal-images/zero-hunger.png');}}" alt="zero hunger"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-3">
                  <img src="{{URL::asset('main/images/goal-images/good-health-well-being.png');}}" alt="good health well being"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-4">
                  <img src="{{URL::asset('main/images/goal-images/quality-education.png');}}" alt="quality education"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-5">
                  <img src="{{URL::asset('main/images/goal-images/gender-equality.png');}}" alt="gender equality"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-6">
                  <img src="{{URL::asset('main/images/goal-images/clean-water-sanitation.png');}}" alt="clean water sanitation"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-7">
                  <img src="{{URL::asset('main/images/goal-images/affordable-clean-energy.png');}}" alt="affordable clean energy"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-8">
                  <img src="{{URL::asset('main/images/goal-images/decent-work-economic-growth.png');}}" alt="decent work economic growth"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-9">
                  <img src="{{URL::asset('main/images/goal-images/industry-innovation-infrastructure.png');}}" alt="industry innovation infrastructure"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-10">
                  <img src="{{URL::asset('main/images/goal-images/reduced-inequalities.png');}}" alt="reduced inequalities"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-11">
                  <img src="{{URL::asset('main/images/goal-images/sustainable-cities-communities.png');}}" alt="sustainable cities communities"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-12">
                  <img src="{{URL::asset('main/images/goal-images/responsible-consumption-production.png');}}" alt="responsible consumption production"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-13">
                  <img src="{{URL::asset('main/images/goal-images/climate-action.png');}}" alt="climate action"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-14">
                  <img src="{{URL::asset('main/images/goal-images/life-below-water.png');}}" alt="life below water"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-15">
                  <img src="{{URL::asset('main/images/goal-images/life-on-land.png');}}" alt="life on land"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-16">
                  <img src="{{URL::asset('main/images/goal-images/peace-justice-strong-institutions.png');}}" alt="peace justice strong institutions"/>
                </div>
                <div class="fb-awg-selected-goal-image" id="goal-image-17">
                  <img src="{{URL::asset('main/images/goal-images/partnerships-for-goals.png');}}" alt="partnerships for goals"/>
                </div>
              </div>
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewbox="0 0 499 503">
                  <defs>
                  ...
                  <g fill="none" fill-rule="evenodd">
                      <path class="fb-goal-fragment goal-trigger-17" fill="#183668" d="M245.394 109.394L242.577.27c-25.621.779-50.787 5.514-74.654 13.818l35.347 103.225c13.465-4.72 27.66-7.447 42.124-7.92"/>
                      <g transform="translate(186 33)" class="fb-goal-trigger-icon goal-icon-17">
                      ...
                      <path class="fb-goal-fragment goal-trigger-11" fill="#F99D26" d="M140.072 340.471l-84.787 68.597a251.975 251.975 0 0 0 55.592 50.605l60.21-91.007a142.3 142.3 0 0 1-31.015-28.195"/>
                      <path class="fb-goal-fragment goal-trigger-10" fill="#E11484" d="M179.1 373.62l-54.022 94.874a248.605 248.605 0 0 0 71.603 27.519l22.755-106.793a140.335 140.335 0 0 1-40.336-15.6"/>
                      <path class="fb-goal-fragment goal-trigger-9" fill="#F36D25" d="M213.582 499.047c11.529 1.661 45.16 6.675 76.704 0l-20.481-108.085c-19.693 2.917-34.337.95-40.84 0l-15.383 108.085z"/>
                      <path class="fb-goal-fragment goal-trigger-12" fill="#CF8D2A" d="M114.862 294.054L11.025 327.347a250.187 250.187 0 0 0 34.315 68.664l89.115-62.935c-8.418-11.794-15.082-24.919-19.593-39.022"/>
                      <path class="fb-goal-fragment goal-trigger-7" fill="#FDB713" d="M328.34 368.484l61.17 90.37a251.92 251.92 0 0 0 56.054-51.906L360.069 339.2c-9.02 11.299-19.71 21.198-31.73 29.284"/>
                      <path class="fb-goal-fragment goal-trigger-6" fill="#00AED9" d="M365.813 331.495l89.872 61.798c13.999-20.274 25.096-42.708 32.682-66.708L384.37 293.8a141.263 141.263 0 0 1-18.557 37.695"/>
                      <path class="fb-goal-fragment goal-trigger-8" fill="#8F1838" d="M280.331 389.076l24.274 106.47a248.6 248.6 0 0 0 70.929-27.914l-55.115-94.227a140.352 140.352 0 0 1-40.088 15.67"/>
                      <path class="fb-goal-fragment goal-trigger-1 active" fill="#EA1C2D" d="M296.014 116.99l36.214-103.012C308.965 5.835 284.137 1.034 258.315.146l-4.105 109.108c14.604.472 28.643 3.154 41.804 7.736"/>
                      <path class="fb-goal-fragment goal-trigger-3" fill="#279B48" d="M374.322 184.009l96.168-51.423a251.661 251.661 0 0 0-45.2-60.481l-76.576 77.69a142.088 142.088 0 0 1 25.608 34.214"/>
                      <path class="fb-goal-fragment goal-trigger-2" fill="#D3A029" d="M341.836 143.474l71.335-82.58c-19.668-17.012-42.006-31.013-66.302-41.282l-42.562 100.53c13.76 5.79 26.388 13.717 37.53 23.332"/>
                      <path class="fb-goal-fragment goal-trigger-14" fill="#007DBC" d="M121.48 190.703l-98.55-46.711a249.329 249.329 0 0 0-21.832 75.285l108.157 13.886c1.864-15.01 6.05-29.289 12.224-42.46"/>
                      <path class="fb-goal-fragment goal-trigger-4" fill="#C31F33" d="M389.901 233.26l108.18-13.674a249.397 249.397 0 0 0-20.796-73.297l-99.136 45.484a140.787 140.787 0 0 1 11.752 41.487"/>
                      <path class="fb-goal-fragment goal-trigger-16" fill="#00558A" d="M194.56 119.73L152.824 18.865c-23.64 9.91-45.438 23.348-64.744 39.654l69.992 83.702c10.88-9.232 23.154-16.864 36.488-22.49"/>
                      <path class="fb-goal-fragment goal-trigger-15" fill="#3EB049" d="M151.53 148.743L76.333 69.681a251.718 251.718 0 0 0-46.621 60.935l95.562 52.528c6.96-12.798 15.857-24.375 26.258-34.4"/>
                      <path class="fb-goal-fragment goal-trigger-5" fill="#EF402B" d="M492.046 311.075c4.785-19.319 8.632-55.47 6.061-76.609l-107.152 8.421c-.023 11.767-2.026 31.074-4.75 42.004l105.841 26.184z"/>
                      <path class="fb-goal-fragment goal-trigger-13" fill="#48773E" d="M7.217 311.075c-4.785-19.319-8.632-55.47-6.061-76.609l107.151 8.421c.024 11.767 2.027 31.074 4.75 42.004L7.217 311.075z"/>
                      <g class="fb-goal-trigger-icon goal-icon-16" transform="translate(121 62)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-12" transform="translate(54 318)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-11" transform="translate(100 377)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-10" transform="translate(160 419)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-1">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-2" fill="#FEFEFE">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-3" transform="translate(391 116)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-4">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-5" transform="translate(430 246)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-6" transform="translate(408 319)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-7">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-8" transform="translate(297 420)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-9" transform="translate(229 436)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-13">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-14" transform="translate(34 170)">
                      ...
                      <g class="fb-goal-trigger-icon goal-icon-15" transform="translate(74 106)">
          ...
          <div class="fb-awg-ff-table-cell fb-awg-ff-goal-detail-wrapper wow fadeInRight">
          <?php $i = 1; ?>
            @foreach($categories as $category)
            
                       <!-- <a href="#" data-id="{{$category->id}}">{{$category->categoryname}}</a> -->
                        <div class="fb-awg-ff-goal-detail-content goal-content-{{$i}} {{ $i==1 ? 'active' : '' }}"><!-- main div start here -->
 <h3 class="fb-awg-ff-goal-head">{{$category->categoryname}}</h3>

   <p class="fb-awg-ff-goal-description">{{$category->category_text}}</p>
                <div class="fb-awg-ff-goal-statistics">
                  <span class="fb-awg-ff-stats-container">
                    <span class="fb-awg-ff-stats-icon"><i class="icon-pledge"></i></span>
                    
                   
                    
                    <?php
        //App::make("UserController")->displayUsers(array('cat_id' => 55));            
$data = DB::table('pledge')->where('pledge_cat',$category->id)->count();


                    ?>
                    <span class="fb-awg-ff-stats-text"><?php echo $data;?>people pledged</span>
                  </span>
                  <span class="fb-awg-ff-stats-container">
                    <span class="fb-awg-ff-stats-icon"><i class="icon-support"></i></span>

                    <span class="fb-awg-ff-stats-text"> 0 people supported</span>
                  </span>
                </div>
                <span class="fb-awg-ff-pledge-projects-btn-wrapper">
                <!-- <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#alignSuccessModal">Launch demo modal</button> -->
                  <a class="fb-primary-action-btn fb-awg-pledge-btn" data-toggle="modal" data-target="#" data-id="{{$category->id}}" href="#"><i class="icon-right-arrow"></i> <span>TAKE A PLEDGE</span></a>
                  <a href="{{URL::to('support/project')}}" class="fb-secondary-btn fb-view-project-btn">
                    <svg>
                      <rect x="0" y="0" rx="2" ry="2" fill="none" width="100%" height="100%"></rect>
                    </svg>
                    VIEW PROJECTS
                  </a>
                </span>
        ...
        <span class="fb-awg-learn-more-btn-wrap">
      ...
      <section class="fb-stats-section wow fadeInUp" id="awg-section-2">
	  <div class="fb-section-head-wrap">
            <h3 class="fb-section-head">Your pledge matters!</h3>
            
          </div>
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-md-5">
			 <img src="{{URL::asset('main/images/ambaasador.png');}}" style="margin-top:10px;" alt="ambaasador" width=100% />
              <div class="fb-stats-video-twitter-wrapper" style="display:none;">
                <a href="https://www.youtube.com/watch?v=vvtzGkKJWro" class="fb-home-news-slide popup-youtube">
                  <img src="{{URL::asset('main/images/youtube.png');}}" alt="news image 1" />
                  <div class="fb-home-news-slide-content">
                    <i class="icon-video"></i>
                    <p class="fb-home-news-slide-text">Casar Jacobson speaks about the UN SDGs</p>
                  </div>
                </a>
              </div>
            </div>
			...
			<p class="fb-ff-content-para" style="text-align:justify;">The World’s largest lesson: Everyone must know!</p>
<p class="fb-ff-content-para" style="text-align:justify;">The Global Goals got off to a good start and need to keep the momentum going. Where the Millennium Development Goals lacked in people power, the SDGS need to aim higher to ensure success. The framework of the Global Goals has been ratified by 193 countries. Policies have been framed around these goals andmillionsare aligning towards this global movement. </p> 
<p class="fb-ff-content-para" style="text-align:justify;">Creating awareness about these goals will immensely contribute to the success of the SDGs.</p>
<p class="fb-ff-content-para" style="text-align:justify;">Take a pledge, share it on social media, and join the generation that will witness the end of poverty by 2030.</p>

<P class="fb-ff-content-para"><span class="fb-testimonial-author" style="font-size:16px;">Ms.Casar Jacobson<br/>
Former Miss Canada<br/>UN Youth Ambassador<br/>Brand Ambassador FreeBasics Inc.</span></p>


              <div class="fb-awg-twitter-section" style="display:none;">
                <span class="fb-awg-twitter-badge">
                  <i class="icon-twitter"></i>
                </span>
               <!--  <a class="twitter-timeline"  href="https://twitter.com/hashtag/design" data-widget-id="852452511894179841" data-width="100%" data-height="400" data-chrome="noheader, nofooter, noborders, transparent, noscrollbar" data-tweet-limit="1">#design Tweets</a> -->
               <a class="twitter-timeline" href="https://twitter.com/Freebasics" data-height="400" data-chrome="noheader, nofooter, noborders, transparent, noscrollbar" data-tweet-limit="1">Tweets by @{Freebasics}</a>
              </div>
            </div>
          </div>
          <div class="row fb-stats-wrapper" style="display:none;">
            <div class="col-xs-12 col-sm-4 col-md-4">
              <div class="fb-stats-card wow fadeInUp" data-wow-delay="0.5s">
                <h4 class="fb-stats-card-head"><span class="counter">30,000</span></h4>
                <p class="fb-stats-card-description">people every year killed due to landmines</p>
              </div>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-4">
              <div class="fb-stats-card wow fadeInUp" data-wow-delay="0.1s">
                <h4 class="fb-stats-card-head"><span class="counter">1</span> million+</h4>
                <p class="fb-stats-card-description">malaria deaths every year</p>
              </div>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-4">
              <div class="fb-stats-card wow fadeInUp" data-wow-delay="1.3s">
                <h4 class="fb-stats-card-head"><span class="counter">600,000</span> </h4>
                <p class="fb-stats-card-description">deaths due to natural disasters in the last 20 years</p>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section class="fb-testimonial-section wow fadeInUp" id="awg-section-3">
        <div class="container">
          <div class="fb-section-head-wrap">
            <h3 class="fb-section-head">Testimonials</h3>
              </div>
             <div class="fb-testimonial-slider-wrapper">
            <div id="testimonial-slider" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <div class="fb-testimonial-slide">
                    <div class="fb-testimonial-slider-image">
                      <img src="{{URL::asset('main/images/aftab.jpg')}}" alt="testimonial image "/>
                    </div>
                    <div class="fb-testimonial-content-wrapper">
                      <p class="fb-testimonial-para">We have less than 5000 days to make the Global Goals successful. Each country is responsible to bring people, corporates and non-profit organizations together to end poverty, fix climate changes and reduce inequalities by 2030. I start with pledging my support for the Global Goals.</p>
                      <span class="fb-testimonial-author">- Aftab Pashaw</span>
                    </div>
                  </div>
                </div>
                <div class="item">
                  <div class="fb-testimonial-slide">
                    <div class="fb-testimonial-slider-image">
                      <img src="{{URL::asset('main/images/richardnew.jpg')}}" alt="testimonial image "/>
                    </div>
                    <div class="fb-testimonial-content-wrapper">
                      <p class="fb-testimonial-para">It is amazing that we now have an opportunity within our control to make the world a better place. The time for us to act is NOW! I have pledged my support for the Global Goals and request you to make a difference by your support.</p>
                      <span class="fb-testimonial-author">- Richard Andrew</span>
                    </div>
                  </div>
                </div>
              </div>
              <a class="left fb-testimonial-slider-controls" href="#testimonial-slider" role="button" data-slide="prev">
                <i class="icon-secondary-left-arrow"></i>
                <span class="sr-only">Previous</span>
              </a>
              <a class="right fb-testimonial-slider-controls" href="#testimonial-slider" role="button" data-slide="next">
                <i class="icon-secondary-right-arrow"></i>
                <span class="sr-only">Next</span>
              </a>
            </div>
          </div>
          <ul class="fb-parallellogram-stats-section wow fadeInUp" style="display:none;">
            <li>
              <span class="fb-parallellogram-back-skew">
                <h4 class="fb-parallellogram-stats-head">30,000</h4>
                <p class="fb-parallellogram-stats-description">people every year killed due to landmines</p>
              </span>
            </li>
            <li>
              <span class="fb-parallellogram-back-skew">
                <h4 class="fb-parallellogram-stats-head">1 Million+</h4>
                <p class="fb-parallellogram-stats-description">malaria deaths every year</p>
              </span>
            </li>
            <li>
              <span class="fb-parallellogram-back-skew">
                <h4 class="fb-parallellogram-stats-head">600,000</h4>
                <p class="fb-parallellogram-stats-description">deaths due to natural disasters in the last 20 years</p>
              </span>
            </li>
          </ul>
        </div>
	  ...
	  <section class="wow fadeInUp" id="awg-section-4" style="background:none;">
        <div class="fb-section-head-wrap">
          <h3 class="fb-section-head">Take Action</h3>
        </div>
        <div class="fb-fifth-fold-content-wrap">
          <div class="container">
            <div class="row">
              <div class="col-md-4 col-xs-12">
                <div class="fb-ff-content-grid wow fadeInUp" data-wow-delay="0.3s">
                  <span class="fb-ff-content-grid-image">
                    <img src="{{URL::asset('main/images/align-with-goal.svg');}}" alt="align with goal" />
                  </span>
                  <h3 class="fb-ff-content-head">Take a Pledge</h3>
                  <p class="fb-ff-content-para">Each pledge is counted and shared on social media to track the country’s level of awareness</p>
                </div>
              </div>
              <div class="col-md-4 col-xs-12">
                <div class="fb-ff-content-grid wow fadeInUp" data-wow-delay="0.6s">
                  <span class="fb-ff-content-grid-image">
                    <img src="{{URL::asset('main/images/show-your-support.svg');}}" alt="show your support" />
                  </span>
                  <h3 class="fb-ff-content-head">Support a Project</h3>
                  <p class="fb-ff-content-para">You can create, promote and fund a project under each of the 17 Global Goals</p>
                </div>
              </div>
              <div class="col-md-4 col-xs-12">
                <div class="fb-ff-content-grid wow fadeInUp" data-wow-delay="0.9s">
                  <span class="fb-ff-content-grid-image">
                    <img src="{{URL::asset('main/images/share-your-voice.svg');}}" alt="share your voice" />
                  </span>
                  <h3 class="fb-ff-content-head">Spread the Word</h3>
                  <p class="fb-ff-content-para">Become a champion of the Global Goals and spread the word in your network</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="fb-vision-section wow fadeInUp" id="awg-section-4" style="display:none;">
        <div class="container fb-vision-container">
          <div class="fb-section-head-wrap">
            <h3 class="fb-section-head">Our FreeBasics model works on 5 key tenets:</h3>
          </div>
          <ul class="fb-vision-list">
            <li>
              <span class="fb-vision-icon">
                <i class="icon-tick"></i>
              </span>
              <span class="fb-vision-text">Smart Technology to help move from an asset heavy model to an asset light model</span>
            </li>
            <li>
              <span class="fb-vision-icon">
                <i class="icon-tick"></i>
              </span>
              <span class="fb-vision-text">Smart programs under each of the 17 Sustainable Development Goals</span>
            </li>
            <li>
              <span class="fb-vision-icon">
                <i class="icon-tick"></i>
              </span>
              <span class="fb-vision-text">Smart Processes and Platforms to connect the governments, charities, society and people – the key players for a truly sustainable future</span>
            </li>
            <li>
              <span class="fb-vision-icon">
                <i class="icon-tick"></i>
              </span>
              <span class="fb-vision-text">Integration of Social Media to raise funds and spread awareness</span>
            </li>
            <li>
              <span class="fb-vision-icon">
                <i class="icon-tick"></i>
              </span>
              <span class="fb-vision-text">Smart Funding opportunities for each of the 17 SDGs</span>
            </li>
          </ul>
        </div>
      </section>
...
<div class="modal fade fb-modal fb-cp-success-modal" id="alignSuccessModal" tabindex="-1" role="dialog" aria-labelledby="alignSuccessModalLabel">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="fb-create-project-success-modal-content">
            ...
            <p class="fb-asModal-light-para" style="display:none;">6 of your friends have done the same. Spread the joy!</p>
            <div class="fb-asModal-btns-wrapper" style="display:none;">
              <a href="#" type="button" class="fb-cpsm-thanks-btn">Support this Goal</a>
              <a href="#" type="button" class="fb-read-about-goal-btn">Read about the Goal</a>
            </div>
            <ul class="fb-modal-share-list">
              <li>
                <span>Share:</span>
              </li>
              <li><a href="javascript:fbShare('{{URL::to('align/goal')}}','{{{$category->categoryname}}}', '{{{$category->categorytext}}}', '{{URL::to('main/images/aftab.jpg')}}', 520, 350)" class="fb-share-btn-facebook"><i class="icon-facebook"></i></a></li>
...
<div class="modal fade fb-modal fb-cp-success-modal fb-awg-take-pledge-modal" id="takePledgeModal" tabindex="-1" role="dialog" aria-labelledby="takePledgeModalLabel">
  <div class="vertical-alignment-helper">
    <div class="modal-dialog vertical-align-center" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="fb-create-project-success-modal-content">
            ...
            <p class="fb-awg-pledge-modal-para">From my country, I pledge support for the UN Sustainable Development Goals for the people, planet and prosperity. #FreeBasics #agenda2030</p>
            <p class="fb-awg-pledge-modal-para" style="display:none;"><strong>@UNWOMEN   @FREEBASICS INC</strong></p>
            <div class="fb-awg-pledge-social-media-list-wrapper">
              <ul class="fb-pledge-btns-list">
                <li>
                  <span class="fb-pledge-through-label">Pledge Through:</span>
                </li>
                <li>
                  <a href="{{URL::to('/fblogin')}}" class="fb-share-btn-facebook fb-pledge"><i class="icon-facebook"></i></a>
                  
                 
                </li>
                <li>
                  <a href="{{URL::to('twitter/login')}}" class="fb-share-btn-twitter twitter-pledge"><i class="icon-twitter"></i></a>
                </li>
                <li>
                  <a href="{{URL::to('/googlelogin')}}" class="fb-share-btn-google-plus gplus-pledge"><i class="icon-google-plus"></i></a>
                </li>
                <li>
                  <a href="{{URL::to('instagram/login')}}" class="fb-share-btn-linked-in linked-pledge"><i class="icon-instagram"></i></a>
                </li>
              </ul>
            </div>
          </div>
...
<div class="modal fade fb-modal fb-cp-success-modal fb-awg-take-pledge-modal" id="takePledgeModal1" tabindex="-1" role="dialog" aria-labelledby="takePledgeModalLabel">
  <div class="vertical-alignment-helper">
    <div class="modal-dialog vertical-align-center" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="fb-create-project-success-modal-content">
            ...
            <p class="fb-awg-pledge-modal-para">You have already pledged your support on this goal. Try another goal to record your pledge.</p>
            <p class="fb-awg-pledge-modal-para" style="display:none;"><strong>@UNWOMEN   @FREEBASICS INC</strong></p>
            <div class="fb-awg-pledge-social-media-list-wrapper">
              <ul class="fb-pledge-btns-list" style="display:none;">
                <li>
                  <span class="fb-pledge-through-label">Pledge Through:</span>
                </li>
                <li>
...
<script>
    jQuery(document).ready(function( $ ) {
      ...
      $("meta[property='og\\:title']").attr("content", "SDG 14: Life Below Water");
        $('.counter').counterUp({
            delay: 2,
            time: 1000
        });
	...
	$('.pledge_image').css('display','none');
	$('.pledge_image1').css('display','inline-block');
  }  , 3000 );
    ...
    jQuery(document).on("click","a.fb-awg-pledge-btn", function($) {
//jQuery("button.fb-awg-pledge-btn").click(function(){
...
var baseurl='{{URL::to('/twitter/login')}}'+'/'+cat_id;
var baseurlfb='{{URL::to('fblogin')}}'+'/'+cat_id;
var baseurlgplus='{{URL::to('googlelogin')}}'+'/'+cat_id;
var baseurlinstagram='{{URL::to('/instagram/login')}}'+'/'+cat_id;
//alert(baseurl);
     jQuery('a.fb-pledge').attr('data-id',cat_id);
     jQuery('a.twitter-pledge').attr('data-id',cat_id);
     jQuery('a.gplus-pledge').attr('data-id',cat_id);
     jQuery('a.linked-pledge').attr('data-id',cat_id);
    
    
    jQuery('a.twitter-pledge').attr('href',baseurl);
    jQuery('a.fb-pledge').attr('href',baseurlfb);
    jQuery('a.gplus-pledge').attr('href',baseurlgplus);
    jQuery('a.linked-pledge').attr('href',baseurlinstagram);
	
  jQuery.ajax({
           type:'GET',
           url:'{{URL::to('getpledgedata')}}',
           data:'catid='+cat_id,
           success:function(data){
			  ...
			  if(data.count == 0)
			  {
			   jQuery('#takePledgeModal').modal('show');
              //$("#msg").html(data.msg);
			  ...
			  {
				   jQuery('#takePledgeModal1').modal('show'); 
			  }
           }
        });
...
<script src="{{URL::asset('main/js/align-goal.js');}}"></script>
   ...
   <script>
            ...
            var winTop = (screen.height / 2) - (winHeight / 2);
                    ...
                    window.open('http://www.facebook.com/sharer.php?u=' + url + '&t=Freebasics');
            }
</script>
<script>
