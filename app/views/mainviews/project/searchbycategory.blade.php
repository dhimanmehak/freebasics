                ...
                <form action="{{URL::to('search')}}" method="get">
                    ...
                    <span  class="cats ar-flow"><p>@if($selected=="all") {{trans('messages.allcategories')}} @else {{$selected->categoryname}} @endif</p><i class="fa fa-angle-down"></i>
                        <ul class="drp-arns catagrgi">
                            <i class="hvr"></i>
                            <a href="{{URL::to('search/category')}}/all/{{$sort}}/{{$input}}/<?php if ($selectedcountry == "all") { ?>all<?php } else { ?>{{$selectedcountry->id}}<?php } ?>" style="color: #32a633;"> {{trans('messages.allcategories')}}</a>
                            @foreach($categories as $category)
                            <li>
                                <a href="{{URL::to('search/category')}}/{{$category->id}}/{{$sort}}/{{$input}}/<?php if ($selectedcountry == "all") { ?>all<?php } else { ?>{{$selectedcountry->id}}<?php } ?>"> {{$category->categoryname}} </a>
                            </li>
                            @endforeach
                        </ul>
                    </span> 
                                ...
                                <span class="magis ar-flow" style="width: 180px;"><p>{{trans('messages.enddate')}}</p><i class="fa fa-angle-down"></i>
                                    ...
                                    <span class="magis ar-flow" style="width: 180px;"><p>{{trans('messages.mostfunded')}}</p><i class="fa fa-angle-down"></i>
                                        ...
                                        <ul class="drp-arns magds" style="left:-4px;">
                                            <i class="hvr"></i>
                                            <li>
                                                <a href="{{URL::to('search/category')}}/<?php if ($selected == "all") { ?>all<?php } else { ?>{{$selected->id}}<?php } ?>/magic/{{$input}}/<?php if ($selectedcountry == "all") { ?>all<?php } else { ?>{{$selectedcountry->id}}<?php } ?>"> {{trans('messages.magic')}} </a>
                                            </li>
                                            <li>
                                                <a href="{{URL::to('search/category')}}/<?php if ($selected == "all") { ?>all<?php } else { ?>{{$selected->id}}<?php } ?>/popular/{{$input}}/<?php if ($selectedcountry == "all") { ?>all<?php } else { ?>{{$selectedcountry->id}}<?php } ?>"> {{trans('messages.popularity')}} </a>
                                            </li>
                                            <li>
                                                <a class="" href="{{URL::to('search/category')}}/<?php if ($selected == "all") { ?>all<?php } else { ?>{{$selected->id}}<?php } ?>/new/{{$input}}/<?php if ($selectedcountry == "all") { ?>all<?php } else { ?>{{$selectedcountry->id}}<?php } ?>"> {{trans('messages.newest')}} </a>
                                            </li>
                                            <li>
                                                <a class="" href="{{URL::to('search/category')}}/<?php if ($selected == "all") { ?>all<?php } else { ?>{{$selected->id}}<?php } ?>/enddate/{{$input}}/<?php if ($selectedcountry == "all") { ?>all<?php } else { ?>{{$selectedcountry->id}}<?php } ?>"> {{trans('messages.enddate')}} </a>
                                            </li>
                                            <li>
                                                <a class="" href="{{URL::to('search/category')}}/<?php if ($selected == "all") { ?>all<?php } else { ?>{{$selected->id}}<?php } ?>/funded/{{$input}}/<?php if ($selectedcountry == "all") { ?>all<?php } else { ?>{{$selectedcountry->id}}<?php } ?>"> {{trans('messages.mostfunded')}} </a>
                                            </li>
                                        </ul>

                                    </span>

                                    <span class="magis2 ar-flow" style="width: 180px;"><p>@if($selectedcountry=="all") {{trans('messages.allcountries')}} @else {{$selectedcountry->countryname}} @endif</p><i class="fa fa-angle-down"></i>
