...
<section class="fb-project-banner" style="background:url('{{URL::to('')}}/{{$project->projectimage}}');background-repeat:no-repeat;background-size:cover; ">
    ...
    <div class="container">
      <div class="fb-project-details-main-section">
            ...
            <span class="project-details-video-supported-people">
              ...
              <span>people supported</span>
                            ...
                            if ($explodedata[1] == 'JPEG' || $explodedata[1] == 'PNG' || $explodedata[1] == 'GIF' || $explodedata[1] == 'BMP' ||
                                    $explodedata[1] == 'jpeg' || $explodedata[1] == 'png' || $explodedata[1] == 'gif' || $explodedata[1] == 'bmp' || $explodedata[1] == 'jpg' || $explodedata[1] == 'JPG') {
                                ?>
		...
		$time_left = strtotime($project->endingon)-$curr_timestamp;
			...
			?>
		 <style type="text/css">#widget-dxc_goal_thermometer-2 {padding:20px;}#widget-dxc_goal_thermometer-2 a.therm-button {}#widget-dxc_goal_thermometer-2 a.therm-button:hover {}#widget-dxc_goal_thermometer-2 .therm-tooltip {}</style><div class="dxc-goal-thermometer autosetup " id="widget-dxc_goal_thermometer-2" data-goal-amount="{{round((($project->fundinggoal*$project->rate)*100)/100)}}" data-current-amount="{{round((($project->totalpledgeamount*$project->rate)*100)/100)}}" data-tickmark-segments="3" data-tickmark-width="50" data-animation-time="2000" data-number-prefix="{{$project->currencysymbol}}" data-number-suffix="" data-time-left="<?php echo $time_left;?>" data-days-left-text=" days left," data-hours-left-text=" hours left," data-minutes-left-text=" minutes left," data-timesup-text="Time's up!" data-funded-text="funded">
		 @if($project->dayscount > 0)
		 <a href="{{URL::to('back/reward/')}}/{{$project->id}}" class="fb-primary-action-btn fb-support-project-btn" style="font-size:10px;margin-top:0px;padding:11px 1px;"><i class="icon-right-arrow"></i> <span>SUPPORT THIS PROJECT</span></a>
	 @else
		  <a href="#" class="fb-primary-action-btn fb-support-project-btn" style="font-size:10px;margin-top:0px;padding:11px 1px;"><i class="icon-right-arrow"></i> <span>EXPIRED</span></a>
	   @endif
  ...
  <ul class="fb-pd-tab-trigger-list" role="tablist">
          ...
          <li role="presentation"><a href="#updates" aria-controls="updates" role="tab" data-toggle="tab">Updates (<?php echo count($updates);?>)</a></li>
          <li role="presentation"><a href="#comments" aria-controls="comments" role="tab" data-toggle="tab">Comments (<?php echo count($comments);?>)</a></li>
        </ul>
		</div>
		<div class="col-md-4">
		 @if($project->dayscount > 0)
		 <a href="{{URL::to('back/reward/')}}/{{$project->id}}" class="fb-primary-action-btn fb-support-project-btn" style="padding:11px 1px;"><i class="icon-right-arrow"></i> <span>SUPPORT THIS PROJECT</span></a>
	 @else
		  <a href="#" class="fb-primary-action-btn fb-support-project-btn" style="padding:11px 1px;"><i class="icon-right-arrow"></i> <span>EXPIRED</span></a>
	   @endif
		</div>
  ...
  </div><!-- end second stati bar -->
    <div class="container">
	<div class="col-md-8">
	
      <div class="fb-pd-tab-triggers-wrap">
        <ul class="fb-pd-tab-trigger-list hide_trigger" role="tablist">
          <li role="presentation" class="active"><a href="#about-project" aria-controls="about-project" role="tab" data-toggle="tab">About Project</a></li>
          <li role="presentation"><a href="#updates" aria-controls="updates" role="tab" data-toggle="tab">Updates (<?php echo count($updates);?>)</a></li>
          <li role="presentation"><a href="#comments" aria-controls="comments" role="tab" data-toggle="tab">Comments (<?php echo count($comments);?>)</a></li>
        </ul>
                        ...
                        <div class="fb-comment-timeline-comment-text-section">
                          ...
                          <div class="fb-comment-replies-section" style="display:none;">
                            ...
                            <a href="javascript:void(0);" class="fb-replies-link"><span>2 replies</span> <i class="icon-down-arrow"></i></a>
                                ...
                                <!-- facebook comments -->
                                <div class="fb-comments" data-href="{{URL::to('project/detail')}}/{{$project->id}}" data-width="600" data-numposts="10"></div>
                                <!-- facebook comments -->
                            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="fb-ac-modal-bottom-section">
            ...
            <a href="#" data-toggle="modal" data-target="#contactMeModal" data-dismiss="modal" class="fb-ac-contact-me-btn">Contact me</a>
          </div>
        </div>
      </div>
    </div>
...
jQuery(document).scroll(function() {
   ...
   jQuery('.second_static').css('display','block');
   jQuery('.hide_trigger').css('display','none');
  } else {
   jQuery('.second_static').css('display','none');
   jQuery('.hide_trigger').css('display','block	');
  }
