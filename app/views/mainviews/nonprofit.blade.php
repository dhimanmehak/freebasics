...
<section class="fb-signup-section">
    <div class="container">
       ...
       @if(Session::has('success'))
		...
		<div class="col-md-12">
		<h3 class="fb-section-head">Non profit organizations</h3>
		<p style="font-size:20px;">Are your marketing and fundraising costs high?</p>
		<p style="font-size:20px;">Are you tracking your social impact under the 17 Global Goals? If not, then let’s talk!</p>
		
<p style="font-size:20px;">We at FreeBasics Inc. provide the tools, technology and marketing support to take your projects to the world as well as attract social impact investors and generous donors to support your cause. </p>
</P>
