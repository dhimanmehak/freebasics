...
<div id="content">
    <div class="grid_container">
        <div class="social_activities">
             <a href="{{URL::to('projectlist?project=new')}}"><div class="activities_s thems4" >
                <div class="block_label">
                    New projects<span>{{$newcount}}</span>
                </div>
                <span class="badge_icon user_sl"></span>
                 </div></a>
            <a href="{{URL::to('projectlist?project=live')}}"><div class="activities_s  thems3">
                    <div class="block_label">
                        Live projects<span>{{$livecount}}</span>
                    </div>
                    <span class="badge_icon lightbulb_sl"></span>
                </div></a>
            <a href="{{URL::to('projectlist?project=funded')}}"><div class="activities_s  thems2 " >
                    <div class="block_label">
            ...
            <a href="{{URL::to('projectlist?project=failed')}}"><div class="activities_s  thems1" >
            ...
            <div class="widget_wrap">
                ...
                <div class="widget_content">                   
                    <table class="display data_tbl" id="projecttable">
                        ...
                        <tbody>
                            @foreach($fundedprojects as $key=>$project)
                            <tr>
                                <td class="center">
                                    {{$key+1}}
                                </td>
             ...
             <div class="widget_wrap">
                ...
                <div class="widget_content">                   
                    <table class="display data_tbl" id="projecttable">
                        ...
                        <tbody>
                            @foreach($liveprojects as $key=>$project)
                            <tr>
                                <td class="center">
                                    {{$key+1}}
                                </td>
             ...
             <div class="widget_wrap">
                ...
                <div class="widget_content">                   
                    <table class="display data_tbl" id="projecttable">
                        ...
                        <tbody>
                            @foreach($newprojects as $key=>$project)
                            <tr>
                                <td class="center">
                                    {{$key+1}}
                                </td>
