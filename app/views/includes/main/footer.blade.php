...
<div class="container">
		...
		<li style="display:none;"><a href="{{URL::to('privacy-policy')}}">Privacy Policy</a></li>
		...
		<li style="display:none;"><a href="{{URL::to('terms-conditions')}}">Terms & conditions</a></li>
